...
Once devtools is available you can install Lithics3D from GitHub with either
...
2. from a downloaded .zip file, which can be obtained by clicking
on the green "Code" button on the
[Lithics3D GitHub repository](https://github.com/cornelmpop/Lithics3D) and
selecting "Download Zip." Assuming you have downloaded or copied the .zip to
your working directory (in R, `getwd()` will show you what your working
directory is set to), and that you have downloaded the master branch code,
you can install the package with the following R commands:
